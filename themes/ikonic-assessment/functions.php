...
require_once get_template_directory() . '/inc/ia-redirect-ip.php';
require_once get_template_directory() . '/inc/ia-projects-cpt.php';
require_once get_template_directory() . '/inc/ia-ajax-endpoints.php';
require_once get_template_directory() . '/inc/ia-api.php';
